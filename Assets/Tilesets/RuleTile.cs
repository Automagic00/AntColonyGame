    ...
    public class FancyRuleTile : TileBase
    {
        ...
        public virtual bool RuleMatch(int neighbor, TileBase tile)
        {
            ...
            switch (neighbor)
            {
                ...
                case TilingRule.Neighbor.OtherTile: return tile != m_Self && tile != null && !nullTiles.Contains(tile.name);
                case TilingRule.Neighbor.MustBeNull: return tile == null || nullTiles.Contains(tile.name);
            }
            return true;
        }
